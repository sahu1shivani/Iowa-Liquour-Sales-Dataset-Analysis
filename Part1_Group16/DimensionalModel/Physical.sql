...
--
-- Date Created : Friday, April 07, 2023 19:21:51
...
-- 
-- TABLE: Fact_County_Population 
--

CREATE TABLE Fact_County_Population(
...
CREATE INDEX Ref316 ON Fact_City_Population(GeoSK)
;
-- 
-- INDEX: Ref317 
--

CREATE INDEX Ref317 ON Fact_County_Population(GeoSK)
;
-- 
...
ALTER TABLE Fact_City_Population ADD CONSTRAINT RefDim_Geo16 
    FOREIGN KEY (GeoSK)
    REFERENCES Dim_Geo(GeoSK)
;
...
ALTER TABLE Fact_County_Population ADD CONSTRAINT RefDim_Geo17 
    FOREIGN KEY (GeoSK)
    REFERENCES Dim_Geo(GeoSK)
;
